      ...
      <div className="signup-wrapper">
        <div className="signup-container">
          <div className="signup-container__redirect">
            ...
            <Link
              to="/login"
              style={{ textDecoration: "none", color: "#014178", fontWeight: "bold" }}
            >
              {" "}
              Log in{" "}
            </Link>
          ...
          <form className="signup-container__form" onSubmit={handleSubmit}>
            <div className="signup-container__label">Sign up</div>
            <div>
              <input
                type="text"
                className={emailDiv}
            ...
            <div>
              <div className="signup-container__warning" style={{ color: "red" }}>
                {noInfo}
              </div>
              <input
                type="email"
            ...
            <div className="signup-container__disclaimer">
              <span>
                *For your privacy and anonymity only your username will be displayed to other users
